...
<body>
<form id="itemForm" action="${pageContext.request.contextPath}/item/edit" method="post">
       ...
       <%-- <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="file" name="item.pictureFile"/>
            </td>
        </tr>
        <tr>
            <td>商品简介</td>
            <td>
                <textarea rows="3" cols="30" name="item.detail">${item.detail }</textarea>
            </td>
        </tr>
